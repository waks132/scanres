"""
Network SVD/PCA Analyzer v2.0 (Optimisé)
==========================================
...
class NetworkSVDAnalyzer:
    """
    Moteur d'analyse de réseau basé sur SVD et PCA v2.0
    ...
    def perform_svd_decomposition(self, k: int = None, use_randomized: bool = None):
        ...
        """
        print("\n" + "=" * 60)
        print("PHASE 1 : DÉCOMPOSITION SVD (Optimisée v2.0)")
        print("=" * 60)
    ...
    def reconstruct_reduced_network(self, k: int = 5):
        """Reconstruction du réseau avec k composantes principales"""
        print("\n" + "=" * 60)
        ...
        # Correction du seuil de reconstruction : Utilisation du 90ème percentile au lieu de la moyenne
...
def create_dashboard(analyzer, perturbations, impacts, adj_reconstructed, G_reconstructed, 
    ...
    fig.suptitle("ANALYSE DE RÉSEAU CRITIQUE - SVD & PCA v2.0\n"
...
if __name__ == "__main__":
    print("=" * 80)
    print("APPLICATION D'ANALYSE DE RÉSEAU - SVD & PCA v2.0 (Optimisé)")
